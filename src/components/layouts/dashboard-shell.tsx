...
function buildNavItems(tenantSlug: string): NavItem[] {
  ...
  return [
    ...
    { title: "Barcode & Labels", href: d("/barcode"), icon: ScanBarcode },
    ...
    { title: "Payments", href: d("/payments"), icon: Wallet },
    { title: "Reports", href: d("/reports"), icon: BarChart3 },
    { title: "Import / Export", href: d("/import-export"), icon: Upload },
    { title: "Branches", href: d("/branches"), icon: Building2 },
    { title: "Users", href: d("/users"), icon: UserCog },
    { title: "Roles", href: d("/roles"), icon: Shield },
    { title: "Notifications", href: d("/notifications"), icon: Bell },
    { title: "Activity Logs", href: d("/activity"), icon: History },
    { title: "Subscription", href: d("/subscription"), icon: Crown },
    { title: "Integrations", href: d("/integrations"), icon: Plug },
    { title: "Files & Storage", href: d("/files"), icon: FolderOpen },
    { title: "Business Profile", href: d("/profile"), icon: Store },
